...
class PdfDocument:
    ...
    def __init__(
        ...
        if isinstance(self._orig_input, pathlib.Path):
    ...
    def import_pages(self, pdf, pages=None, index=None):
        ...
        Parameters:
            ...
            index (int):
                Zero-based index at which to insert the given pages. If None, the pages are appended to the end of the document.
        """
        # TODO testing
